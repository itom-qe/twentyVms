...
resource "azurerm_virtual_machine" "vm15" {
	name                  = "vm${count.index}${random_id.server.hex}"
	location              = "${var.region}"
	resource_group_name   = "${data.azurerm_resource_group.rg.name}"
	availability_set_id   = "${azurerm_availability_set.avset.id}"
...
resource "azurerm_virtual_machine" "vm16" {
	name                  = "vm${count.index}${random_id.server.hex}"
	location              = "${var.region}"
	resource_group_name   = "${data.azurerm_resource_group.rg.name}"
	availability_set_id   = "${azurerm_availability_set.avset.id}"
...
resource "azurerm_virtual_machine" "vm17" {
	name                  = "vm${count.index}${random_id.server.hex}"
	location              = "${var.region}"
	resource_group_name   = "${data.azurerm_resource_group.rg.name}"
	availability_set_id   = "${azurerm_availability_set.avset.id}"
...
resource "azurerm_virtual_machine" "vm18" {
	name                  = "vm${count.index}${random_id.server.hex}"
	location              = "${var.region}"
	resource_group_name   = "${data.azurerm_resource_group.rg.name}"
	availability_set_id   = "${azurerm_availability_set.avset.id}"
...
resource "azurerm_virtual_machine" "vm19" {
	name                  = "vm${count.index}${random_id.server.hex}"
	location              = "${var.region}"
	resource_group_name   = "${data.azurerm_resource_group.rg.name}"
	availability_set_id   = "${azurerm_availability_set.avset.id}"
...
resource "azurerm_virtual_machine" "vm20" {
	name                  = "vm${count.index}${random_id.server.hex}"
	location              = "${var.region}"
	resource_group_name   = "${data.azurerm_resource_group.rg.name}"
	availability_set_id   = "${azurerm_availability_set.avset.id}"
